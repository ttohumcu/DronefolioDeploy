...
export function HeroSection({ searchQuery, onSearchChange, activeFilter, setActiveFilter, locationFilter, setLocationFilter, mediaItems }: HeroSectionProps) {
  ...
  return (
    <section className="hero-gradient mt-16 py-16 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center space-x-2 flex-shrink-0">
              {["All", MediaType.PHOTO_4K, MediaType.PANORAMA_180, MediaType.PANORAMA_360, "Videos", "YouTube"].map((filter) => (
                <Button
                  key={filter}
